  ...
  return (
    <main className="page-shell min-h-screen bg-[#050505] text-white">
      ...
      <section className="w-full border-t border-white/5 bg-[#050505] py-24 text-white">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert("Message form functionality ready for backend integration!"); }}>
              ...
              <button type="submit" className="rounded-xl border-2 border-white bg-transparent px-10 py-3.5 text-sm font-bold text-white transition hover:bg-white hover:text-black shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.4)]">
                Send
              </button>
            </form>
          </div>
      ...
      <footer className="w-full border-t border-white/10 bg-black py-8 text-white">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between px-5 sm:flex-row sm:px-6">
          <p className="text-[13px] font-bold tracking-wide text-zinc-500">© {new Date().getFullYear()} Prince Yadav. All Rights Reserved.</p>
          <div className="mt-4 flex gap-6 sm:mt-0">
            <a href="https://github.com/prince-up" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-zinc-400 transition hover:text-white flex items-center gap-2">
            ...
            <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-zinc-400 transition hover:text-white flex items-center gap-2">
